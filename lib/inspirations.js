...
export function saveInspiration({ bytes, mime, title, category, subcategory, types = [], tags = [], detailed_description = '', summary = '', source_text = '', plain_text = '', source_page = '', text_source_page = '', rights = '', source = 'clipboard' }) {
  ...
  const item = {
    ...
    data:{
      ...
      source_text:String(source_text || '').trim(),
      plain_text:String(plain_text || '').trim(),
      source_page:String(source_page || '').trim(),
      text_source_page:String(text_source_page || '').trim(),
...
export function updateInspiration(selector, metadata = {}) {
  ...
  const item = {
    ...
    data:{
      ...
      ...(metadata.summary !== undefined ? { summary:String(metadata.summary).trim() } : {}),
      ...(metadata.source_text !== undefined ? { source_text:String(metadata.source_text).trim() } : {}),
      ...(metadata.plain_text !== undefined ? { plain_text:String(metadata.plain_text).trim() } : {}),
      ...(metadata.source_page !== undefined ? { source_page:String(metadata.source_page).trim() } : {}),
      ...(metadata.text_source_page !== undefined ? { text_source_page:String(metadata.text_source_page).trim() } : {}),
      ...(metadata.rights !== undefined ? { rights:String(metadata.rights).trim() } : {}),
