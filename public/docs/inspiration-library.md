...
“详细”指足以辅助重绘的视觉结构，不是堆叠“唯美、震撼、电影感”等形容词。复杂角色图或多人场景通常写到约 350–650 个汉字：衣服要说明内外层、领口、袖型、开口、连接、纹样位置和反光；场景要说明建筑方位与层级、人物尺度、引导线、遮挡关系和前中后景。简单图片可以更短，但删掉原图后仍应能据此重建主体、空间、光线与材质的主要决策。
...
古籍异兽等条目可以同时保存简介、原文、Harness 独立写出的白话、画像来源、文字来源和权利状态。它们回答“对象是什么”；“详细描述”仍只回答“这张图具体长什么样”。优先使用公有领域原文与古版画像，不批量复制现代绘本、现代译注或创作者插画。
