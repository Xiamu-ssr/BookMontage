...
Seedance 生产任务不要从空白开始。先用 `bookmontage prompt-search <关键词>` 检索 [Seedance 实片库](references/prompt-libraries.md)，看 1–3 条同类型成片与完整长提示词，再结合官方手册、当前资产和人类草稿重写。社区案例是高价值实证，不冒充官方规则，也不原样复制他人角色或 IP。
